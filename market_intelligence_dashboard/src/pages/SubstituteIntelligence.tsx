...
export default function SubstituteIntelligence() {
  ...
  if (isLoading) {
    return (
      <div className="flex py-20 items-center justify-center flex-col gap-3">
        ...
        <p className="text-sm text-muted-foreground font-mono uppercase tracking-widest">Loading Top 10 Alternative Products...</p>
      </div>
    );
  }
  ...
  return (
    <div className="mt-6 space-y-4">
      <div className="mb-6">
        <h2 className="text-2xl font-bold">Top 10 LLM-Inferred Alternative Products</h2>
